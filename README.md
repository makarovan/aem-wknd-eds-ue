...
## Environments
- Preview: https://main--aem-wknd-eds-ue--makarovan.aem.page/
- Live: https://main--aem-wknd-eds-ue--makarovan.aem.live/
...
1. Open the `aem-wknd-eds-ue` directory in your favorite IDE and start coding :)
